...
// use crate::coordinator::Message as CoordinatorMessage;
...
//     let max_glass_dummy: [i32; 256] = [0; 256];
...
//                     to_co.send(Message::WorkUnit(Config::new(None::<Sender<CoordinatorMessage>>, 1, max_glass_dummy, max_glass_dummy))).unwrap();
//                 }
